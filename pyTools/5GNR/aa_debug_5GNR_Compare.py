...
SMW_RefPntA = sQuery(f':SOUR1:BB:NR5G:NODE:CELL0:TXBW:POIN?')
...
# SSB
SMW_SSB_SCS = sQuery(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:SCSP?')
SMW_SSB_Pat = sQuery(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:CASE?')
SMW_SSB_Off = sQuery(f':SOUR1:BB:NR5G:NODE:CELL0:OFFS?')
SMW_SSB_RBO = sQuery(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:RBOF?')
SMW_SSB_Aof = sQuery(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:SCOF?')
