...
FSW_ChanRB  = FSW.query(f':CONF:NR5G:{dir}:CC1:FRAM1:SLOT0:ALL0:RBC?')
FSW_ChanRBO = FSW.query(f':CONF:NR5G:{dir}:CC1:FRAM1:SLOT0:ALL0:RBOF?')
FSW_ChSymb  = FSW.query(f':CONF:NR5G:{dir}:CC1:FRAM1:SLOT0:ALL0:SCO?')
FSW_ChSymbO = FSW.query(f':CONF:NR5G:{dir}:CC1:FRAM1:SLOT0:ALL0:SOFF?')
# --------------
