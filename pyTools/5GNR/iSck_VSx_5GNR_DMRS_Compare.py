...
SMW_ChanRB  = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:RBN?')
SMW_ChanRBO = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:RBOF?')
SMW_ChSymb  = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:SYMN?')
SMW_ChSymbO = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:SYM?')

SMW_configT = SMW.query(f':SOUR1:BB:NR5G:UBWP:USER0:CELL0:{dir}:BWP0:PUSC:DMTA:CTYP?')
...
SMW_addPosi = SMW.query(f':SOUR1:BB:NR5G:UBWP:USER0:CELL0:{dir}:BWP0:PUSC:DMTA:APIN?')
SMW_dmrsLen = SMW.query(f':SOUR1:BB:NR5G:UBWP:USER0:CELL0:{dir}:BWP0:PUSC:DMTA:MLEN?')
SMW_relPowr = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:PUSC:DMRS:POW?')
SMW_MMLayer = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:PUSC:TXSC:NLAY?')
SMW_cdmGrup = SMW.query(f':SOUR1:BB:NR5G:SCH:CELL0:SUBF0:USER0:BWP0:ALL0:PUSC:TXSC:CDMD?')
