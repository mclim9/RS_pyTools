...
# SSB Stuff
FSW_SSB_SCS = FSW.query(f':CONF:NR5G:DL:CC1:SSBL1:SSP?')
FSW_SSB_Pat = FSW.query(f':CONF:NR5G:DL:CC1:SSBL1:PATT?')
FSW_SSB_Off = FSW.query(f':CONF:NR5G:DL:CC1:SSBL1:RTO?')
FSW_SSB_RBO = FSW.query(f':CONF:NR5G:DL:CC1:SSBL1:OFFS?')
FSW_SSB_Aof = FSW.query(f':CONF:NR5G:DL:CC1:SSBL1:ASOF?')
...
# SSB Stuff
SMW_SSB_SCS = SMW.query(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:SCSP?')
SMW_SSB_Pat = SMW.query(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:CASE?')
SMW_SSB_Off = SMW.query(f':SOUR1:BB:NR5G:NODE:CELL0:OFFS?')
SMW_SSB_RBO = SMW.query(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:RBOF?')
SMW_SSB_Aof = SMW.query(f':SOUR1:BB:NR5G:NODE:CELL0:SSPB0:SCOF?')
